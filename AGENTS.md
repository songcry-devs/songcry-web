...
- **Legal text is lawyer reviewed.** Do not edit `content/legal/*.md` or the rendered text of the `app/legal/` pages. Report problems instead. A page's `metadata` export (tab title, share card) is not legal text and may change.
